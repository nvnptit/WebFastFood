...
<body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="${root}/resources/home/index.htm">Vegefoods</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="home/shop.htm" class="nav-link">Products</a></li>
	          <li class="nav-item"><a href="home/about.htm" class="nav-link">About</a></li>
	          <li class="nav-item"><a href="home/blog.htm" class="nav-link">Blog</a></li>
	          <li class="nav-item cta cta-colored"><a href="home/cart.htm" class="nav-link"><span class="icon-shopping_cart"></span>[ ${sessionScope['Orders_list'].size()} ]</a></li>
	        </ul>
	      </div>
	    </div>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.htm">Home</a></span> <span class="mr-2"><a href="index.htm">Product</a></span> <span>Product Single</span></p>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row">
          	...
          	<form method="post" action="${root}/resources/home/addCart.htm">
          	<input type="hidden" value="${product.id}" name="id" /> 
          	<input type="submit"value="Add to Cart" name="btnOK" class="btn btn-black py-3 px-5"/>
          	</form>
    			</div>
    		</div>
    	</div>
