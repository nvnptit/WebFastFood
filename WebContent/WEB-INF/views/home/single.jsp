			...
			<div class="row">
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<div class="rating d-flex">
						...
						<p class="text-left mr-4">
							<a href="#" class="mr-2" style="color: #000;">100 <span
								style="color: rgb(175, 104, 104);"><s:message
										code="single.Rate" /></span></a>
						</p>
						<p class="text-left">
							<a href="#" class="mr-2" style="color: #000;">500 <span
								style="color: rgb(163, 61, 61);"><s:message
										code="single.Sold" /></span></a>
						</p>
					</div>
					<p class="price">
					...
					<div class="row mt-4">
						...
						<div class="w-100"></div>
						<div class="col-md-12">
							<p style="color: rgb(90, 56, 243);">
								<s:message code="single.Remain" />
								${product.quantity}
								<s:message code="single.Product" />
							</p>
					...
					<c:if test="${product.quantity <= 0}">
						<label style="color: red;">Tạm thời hết hàng!</label>
					</c:if>
					<c:if test="${product.quantity > 0}">
