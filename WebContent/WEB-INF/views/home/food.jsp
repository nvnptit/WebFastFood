			...
			<div class="row">
				<div class="col-md-12 ftco-animate">
					...
					<div class="cart-list">
						...
						<form action="${root}/home/food.htm" method="post">
							<input id="myInput" name="searchInput" type="text" placeholder="${searchHere}" style="width: 1000px; height: 50px">
							<button class="fa fa-search" name="btnSearch" type="submit" style="width: 100px; height: 10px; background-color: #82ae46;"></button>
						</form>
						<br>
						<table class="table">
