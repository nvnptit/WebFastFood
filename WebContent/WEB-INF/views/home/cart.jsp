													...
													<div class="col-md-12 ftco-animate">
														...
														<table class="table" id="tab_logic">
															...
															<tbody>
																...
																<c:forEach var="p"
																	items="${sessionScope['Orders_list']}">
																	<tr class="text-center">
																		<td class="product-remove"><button
																				class="btn btn-primary py-3 px-4"
																				style="background-color:#f23939"
																				type="submit" value="${p.id}"
																				name="deleteItem">X</button>
																		...
																		<td>
																			<div class="input-group mb-3">
																				<input type="number" name="total"
																					class="form-control input-number total"
																					value="${p.price}" readonly />
																			</div>
																		</td>
																	</tr><!-- END TR-->
											...
											<div class="row">
												<div class="col-md-12 text-center">
													...
													<p>
														...
														rights reserved | This template is made with <i
