                ...
                <ul class="list-unstyled navbar__list">
                  ...
                  <li class="has-sub">
                    <a class="js-arrow" href="#">
                      <i class="fas fa-tachometer-alt active"></i>Dữ liệu
                    </a>
                            ...
                            <tbody id="myTable">
                              <c:forEach var="p" items="${products}">
                                <tr>
                                  ...
                                  <td>
                                    <div>
                                      <button onclick="openModalForProduct('${p.id}')" class="btn btn-danger">
                                        Xoá
                                      </button>
                                    </div>
                                  </td>
          ...
          <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button id="buttonDeleteConfirm2" type="button" class="btn btn-primary">
                  Xác nhận
                </button>
              </div>
            </div>
