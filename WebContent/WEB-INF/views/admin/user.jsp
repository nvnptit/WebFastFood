                    ...
                    <c:if test="${not empty message}">
                      ...
                      <div class="user-data m-b-30">
                            ...
                            <tbody id="myTable">
                              <c:forEach var="u" items="${users}">
                                <tr>
                                  ...
                                  <td>
                                    <div>
                                      <button onclick="openModalForUser('${u.username}')" class="btn btn-danger">
                                        Xoá
                                      </button>
                                    </div>
                                  </td>
                        ...
                        <div class="user-data__footer">
                          <button onclick="location.href='${root}/admin/form_user.htm'" class="au-btn au-btn-load">
                            Thêm mới người dùng
                          </button>
                        </div>
                      </div>
              ...
              <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button id="buttonDeleteConfirm" type="button" class="btn btn-primary">
                      Xác nhận
                    </button>
                  </div>
                </div>
