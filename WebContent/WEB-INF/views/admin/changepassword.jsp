                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="${root}/resources/images/icon/password.png" style="height:100px" alt="Banana">
                            </a>
                        </div>
                        ...
                        <c:if test="${not empty message}">
                            ...
                            <form action="changepassword.htm" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="password" name="oldpass" required/>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="password" name="confirmpass" required/>
                                </div>
