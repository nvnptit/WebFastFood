                      ...
                      <div class="au-task-list js-scrollbar3">
                        <div class="au-task__item au-task__item--danger">
                          <div class="au-task__item-inner">
                            <h5 class="task">
                              <a href="#"
                                >Meeting about plan for Admin Template 2021</a
                              >
                            </h5>
                        ...
                        >
                          <div class="au-task__item-inner">
                            <h5 class="task">
                              <a href="#"
                                >Tạo nhiệm vụ mới cho trang bảng biểu</a
                              >
                            </h5>
                            <span class="time">11:00 AM</span>
                          </div>
                            ...
                            <div class="au-message__item-inner">
                              <div class="au-message__item-text">
                                <div class="avatar-wrap">
                                  <div class="avatar">
                                    <img
                                      src="${root}/resources/images/icon/avatar-02.jpg"
                                      alt="John Smith"
                                    />
                                  </div>
                                </div>
                            ...
                            <div class="au-message__item-inner">
                              <div class="au-message__item-text">
                                <div class="avatar-wrap online">
                                  <div class="avatar">
                                    <img
                                      src="${root}/resources/images/icon/avatar-03.jpg"
