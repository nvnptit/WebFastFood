...
<html lang="en">
  ...
  <head>
    ...
    <!-- Fontfaces CSS-->
    <link
      href="${root}/resources/css/font-face.css"
      rel="stylesheet"
      media="all"
    />
    <link
  ...
  <body class="animsition">
    ...
    valid redirect to error page { response.sendRedirect("login.htm"); return;
    // to stop further execution } i++; } } else {
    response.sendRedirect("login.htm"); return; // to stop further execution }
    %> --%>
        ...
        <div class="main-content">
                ...
                <div class="col-md-12">
                  ...
                  <div class="user-data m-b-30">
                    <h3 class="title-3 m-b-30">
                      <i class="zmdi zmdi-account-calendar"></i>Dữ liệu người
                      dùng
                    </h3>
                          ...
                          <c:forEach var="u" items="${users}">
                            <tr>
                              ...
                              <td>
                                <div>
                                  <button
                                    onclick="openModalForUser('${u.username}')"
                    ...
                    <div class="user-data__footer">
                      <button
                        onclick="location.href='form_user/insert.htm'"
                        class="au-btn au-btn-load"
                      >
                        Thêm
                      </button>
                    </div>
                          ...
                          <c:forEach var="p" items="${products}">
                            <tr>
                              ...
                              <td>
                                <div>
                                  <button
                                    onclick="openModalForProduct('${p.id}')"
                                    class="btn btn-danger"
                                  >
                                    Xoá
                                  </button>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="copyright">
                <p>
                  Copyright © 2021 Colorlib. All rights reserved. Template by
